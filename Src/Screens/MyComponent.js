...
import { View, Button, StyleSheet ,FlatList, ScrollView,Text} from 'react-native';
...
const MyComponent = () => {
  ...
  return (
    ...
    <View style={styles.trafficLightContainer}>
      <View style={[styles.light, { backgroundColor: apiStatus === 'red' ? 'red' : 'grey' }]} />
      <View style={[styles.light, { backgroundColor: apiStatus === 'yellow' ? 'yellow' : 'grey' }]} />
      <View style={[styles.light, { backgroundColor: apiStatus === 'green' ? 'green' : 'grey' }]} />
       {/* // Status  showing */}
